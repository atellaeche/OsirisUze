...
typedef struct player
{
	...
	char casillaY;	
	bool death;
	bool pared; //Esta pegado a una pared.
	char plydir;
} player;
...
const char mapa1_1[15][15] PROGMEM = {
	...
	{11, 00, 00, 00, 00, 00, 00, 00, 00, 04, 00, 00, 11, 01, 01},
	{11, 07, 23, 10, 24, 00, 00, 00, 00, 00, 00, 00, 11, 01, 01},
...
const char mapa1_2[15][15] PROGMEM = {
	...
	{11, 00, 00, 00, 00, 21, 10, 10, 10, 07, 10, 01, 01, 01, 01},
...
const char mapa2_1[15][15] PROGMEM = {
	...
	{11, 00, 00, 00, 14, 00, 11, 01, 01, 11, 05, 07, 00, 11, 01},
	{11, 00, 00, 00, 11, 00, 11, 01, 01, 21, 10, 24, 00, 11, 01},
	{11, 00, 00, 00, 11, 04, 11, 01, 01, 01, 01, 11, 00, 11, 01},
...
const char mapa2_2[15][15] PROGMEM = {
	...
	{11, 00, 07, 06, 01, 01, 01, 01, 01, 01, 01, 01, 01, 01, 01},
...
const char mapa3_1[15][15] PROGMEM = {
	...
	{01, 01, 01, 11, 00, 20, 00, 04, 20, 00, 40, 11, 01, 01, 01},
	{01, 01, 01, 11, 00, 00, 00, 00, 00, 00, 00, 11, 01, 01, 01},
	{01, 01, 01, 11, 00, 00, 00, 00, 00, 00, 00, 11, 01, 01, 01},
	...
	{01, 01, 01, 01, 11, 00, 07, 00, 00, 00, 00, 00, 05, 11, 01},
...
const char mapa3_2[15][15] PROGMEM = {
	...
	{01, 01, 01, 01, 11, 06, 00, 00, 00, 00, 00, 07, 00, 11, 01},
...
const char mapa4_1[15][15] PROGMEM = {
	...
	{01, 01, 01, 01, 23, 10, 18, 10, 13, 00, 11, 04, 00, 11, 01},
	...
	{01, 01, 11, 00, 00, 42, 00, 00, 23, 24, 00, 07, 05, 11, 01},
...
const char mapa4_2[15][15] PROGMEM = {
	...
	{01, 01, 01, 01, 01, 01, 01, 01, 01, 24, 06, 07, 00, 11, 01},
...
const char mapa5_1[15][15] PROGMEM = {
	...
	{01, 01, 01, 01, 01, 01, 01, 01, 11, 00, 12, 10, 24, 07, 11},
	...
	{01, 11, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 04, 11, 01},
...
const char mapa5_2[15][15] PROGMEM = {
	...
	{01, 01, 01, 01, 11, 07, 21, 10, 10, 24, 01, 01, 01, 01, 01},
...
const char mapa6_1[15][15] PROGMEM = {
	...
	{01, 11, 00, 00, 04, 11, 00, 00, 20, 00, 00, 00, 00, 11, 01},
	...
	{01, 11, 00, 00, 00, 00, 00, 00, 00, 11, 00, 07, 05, 11, 01},
...
const char mapa6_2[15][15] PROGMEM = {
	...
	{01, 01, 01, 01, 01, 01, 10, 06, 07, 00, 11, 01, 01, 01, 01},
...
const char mapa7_1[15][15] PROGMEM = {
	...
	{01, 11, 00, 04, 00, 00, 11, 01, 01, 01, 11, 00, 23, 22, 01},
	{01, 11, 00, 00, 00, 00, 11, 01, 01, 01, 11, 00, 17, 10, 10},
	{01, 21, 10, 10, 10, 10, 22, 01, 01, 01, 11, 00, 15, 00, 00},
	{01, 01, 01, 01, 01, 01, 01, 01, 01, 01, 11, 00, 07, 05, 23},
...
const char mapa7_2[15][15] PROGMEM = {
	...
	{01, 11, 06, 07, 00, 23, 24, 00, 11, 00, 11, 01, 01, 01, 01},
...
const char mapa8_1[15][15] PROGMEM = {
	...
	{11, 00, 00, 00, 00, 00, 23, 10, 24, 00, 11, 00, 14, 07, 21},
	...
	{11, 00, 04, 00, 40, 23, 22, 01, 11, 00, 00, 23, 22, 01, 01},
...
const char mapa8_2[15][15] PROGMEM = {
	...
	{11, 07, 21, 22, 00, 11, 11, 00, 11, 01, 01, 01, 01, 01, 01},
...
const char mapa9_1[15][15] PROGMEM = {
	...
	{01, 23, 10, 10, 10, 24, 01, 01, 23, 22, 43, 00, 04, 11, 01},
	...
	{01, 11, 05, 00, 07, 00, 11, 01, 21, 10, 10, 10, 10, 22, 01},
...
const char mapa9_2[15][15] PROGMEM = {
	...
	{01, 11, 00, 07, 00, 06, 11, 01, 01, 01, 01, 01, 01, 01, 01},
	{01, 11, 00, 23, 10, 10, 22, 01, 01, 01, 01, 01, 01, 01, 01},
...
const char mapa10_1[15][15] PROGMEM = {
	...
	{01, 01, 23, 22, 00, 43, 00, 00, 11, 11, 05, 00, 07, 00, 11},
	...
	{01, 11, 00, 00, 00, 00, 00, 00, 00, 00, 00, 11, 11, 04, 11},
...
const char mapa10_2[15][15] PROGMEM = {
	...
	{01, 01, 01, 01, 01, 01, 01, 01, 01, 11, 00, 07, 00, 06, 11},
...
// 05 --> Avanzar Sala
// 06 --> Retroceder Sala
// 07 --> Posición Personaje al cambio
...
bool isSolid(char x, char y)
{
	...
	if (result == 5){
		...
		// Crear función de este for, se usa tres veces. (int mapa para saber que mapa)
		for(int a = 0; a < 15; a++){ 
			for(int b = 0; b < 15; b++){
				cambio = mapa2[a][b];
		...
		// Crear función de este for, se usa tres veces.
		for(int a = 0; a < 15; a++){ 
			for(int b = 0; b < 15; b++){
				cambio = mapa1[a][b];
